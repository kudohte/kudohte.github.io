# 今後に向けて取り組んでいること
長期的にネットワークデバイス機器の運用理解と次拠点での社内ネットワークの構築を目標として勉強しております。
現職のセキュリティ業務にも関連する、情報処理安全確保支援士の資格取得に向けても勉強中です。
2025年に社内のCTFコンテストにて、診断業務未経験枠での入賞をきっかけに各種CTFコンテストへ参加しています。
